...
@section('content')
<style>
    /* ========== DESIGN SYSTEM (identique dashboard / liste employés) ========== */
    :root {
        --primary: #FF6200;
...
<div class="page-header animate-in">
    <div>
        <h1 class="page-title"><i class="fas fa-user-plus" style="color:var(--primary);"></i> Nouvel <span>employé</span></h1>
        <p class="page-subtitle">Remplissez les informations en 3 étapes simples</p>
    </div>
...
<div class="form-guide-layout">
    ...
    <div class="form-card animate-in delay-1">
        <form method="POST" action="{{ route('admin.employees.store') }}">
            ...
            <div class="step-content" id="step-3">
                <h3 style="font-family:'Clash Display', sans-serif; font-size:20px; margin-bottom:20px;">
                    <i class="fas fa-check-circle" style="color:var(--primary);"></i> Confirmation
                </h3>
                <p style="color: var(--gray-600); margin-bottom: 24px;">Vérifiez les informations saisies dans les étapes précédentes avant de créer l'employé.</p>
                <div style="background: var(--gray-50); border-radius: var(--radius-sm); padding: 16px; color: var(--gray-800);">
                    <i class="fas fa-info-circle" style="color:var(--primary);"></i> L'employé sera enregistré avec le statut <strong>Actif</strong> par défaut.
                </div>
            </div>
    ...
    <div class="bento-card animate-in delay-2" style="position: sticky; top: 100px;">
        <h3 class="card-title"><i class="fas fa-lightbulb"></i> Guide express</h3>
        
        <div class="guide-item">
            <div class="guide-icon"><i class="fas fa-user-plus"></i></div>
            <div class="guide-text">
                <strong>1. Créez un compte</strong>
                <p>Remplissez le nom, l'email, le mot de passe et le rôle. Un compte utilisateur sera automatiquement généré.</p>
            </div>
        </div>

        <div class="guide-item">
            <div class="guide-icon"><i class="fas fa-id-card"></i></div>
            <div class="guide-text">
                <strong>2. Complétez la fiche</strong>
                <p>Ajoutez le poste, le département, le type de contrat et le salaire. Ces informations seront visibles dans la liste.</p>
            </div>
        </div>
        ...
        <div class="guide-item">
            ...
            <div class="guide-text">
                <strong>3. Après la création</strong>
                <p>L'employé pourra se connecter avec ses identifiants. Vous pourrez ensuite modifier son statut, le suspendre ou le supprimer.</p>
            </div>
        </div>

        <div style="margin-top: 24px; padding-top: 16px; border-top: 1px solid var(--gray-100);">
            <p style="font-size: 13px; color: var(--gray-600);">
                <i class="fas fa-asterisk" style="color: var(--primary);"></i> Les champs marqués d'un astérisque sont obligatoires.
            </p>
        </div>
    </div>
</div>

{{-- Script de navigation entre étapes --}}
<script>
