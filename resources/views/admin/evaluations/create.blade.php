...
<div class="page-header animate-in">
    <div>
        ...
        <p class="page-subtitle">Évaluez un employé</p>
    </div>
...
<div class="form-card animate-in delay-1">
    <form method="POST" action="{{ route('admin.evaluations.store') }}">
        ...
        <div class="form-group">
            <label class="form-label"><i class="fas fa-calendar"></i> Période * (ex: T1 2026)</label>
            <input type="text" name="period" class="form-input" required placeholder="Ex: 1er trimestre 2026">
        </div>
        <div class="form-group">
            <label class="form-label"><i class="fas fa-star"></i> Note * (0 à 5)</label>
            <input type="number" name="score" class="form-input" required min="0" max="5" step="0.1" placeholder="Ex: 4.5">
        </div>
        <div class="form-group">
            <label class="form-label"><i class="fas fa-comment"></i> Commentaires</label>
            <textarea name="comments" rows="4" class="form-textarea" placeholder="Points forts, axes d'amélioration..."></textarea>
        </div>
        <div class="form-group">
            <label class="form-label"><i class="fas fa-calendar-check"></i> Date de l'évaluation</label>
            <input type="date" name="evaluated_at" class="form-input" value="{{ now()->format('Y-m-d') }}">
        </div>
        <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Enregistrer l'évaluation</button>
    </form>
</div>
@endsection