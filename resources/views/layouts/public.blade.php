...
<head>
    ...
    <!-- Font Awesome: jsDelivr Fallback -->
    <link rel="stylesheet" 
          href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.6.0/css/all.min.css"
          media="print" onload="this.media='all'">

    <!-- Font Awesome: unpkg Second Fallback -->
    <noscript>
        <link rel="stylesheet" 
    ...
    <style>
        ...
        * {
        ...
        /* Decorative Circles in Mobile Menu */
        .mobile-menu::before {
            content: '';
            position: absolute;
            width: 400px;
...
<body class="@yield('bodyClass', '')">
    ...
    <div class="logo-text">
        <span class="mania" style="color: white">Mania</span><span class="pme">-PME</span>
    </div>
</a>
                <!-- <h3>Mania-PME</h3> -->
                ...
                <div class="footer-socials">
                    <a href="https://linkedin.com" target="_blank" class="footer-social-link" title="LinkedIn">
                        <i class="fab fa-linkedin-in"></i>
                    </a>
                    <a href="https://twitter.com" target="_blank" class="footer-social-link" title="Twitter">
                        <i class="fab fa-twitter"></i>
                    </a>
                    <a href="https://facebook.com" target="_blank" class="footer-social-link" title="Facebook">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://whatsapp.com" target="_blank" class="footer-social-link" title="WhatsApp">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                    <a href="https://instagram.com" target="_blank" class="footer-social-link" title="Instagram">
        ...
        <div class="footer-bottom">
            <div class="footer-copyright">
                © {{ date('Y') }} Mania-PME. Tous droits réservés.
            </div>
    ...
    <script>
        ...
        (function() {
            function testFA() {
                ...
                s.className = 'fas fa-check';
                s.style.cssText = 'position:absolute;visibility:hidden;font-family:FontAwesome';
                document.body.appendChild(s);
                var ok = window.getComputedStyle(s).fontFamily.includes('Font Awesome') 
                         || window.getComputedStyle(s).width !== '0px';
