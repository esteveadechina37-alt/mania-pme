...
<div class="page-header animate-in">
    ...
    <a href="{{ route('employee.evaluations.index') }}" class="btn-outline">
...
<div class="content-grid">
    ...
    <div class="guide-card animate-in delay-2" style="position: sticky; top: 100px;">
        <h3 class="card-title"><i class="fas fa-lightbulb"></i> Comprendre votre évaluation</h3>
        <div class="guide-item">
            <div class="guide-icon"><i class="fas fa-star"></i></div>
            <div class="guide-text">
                <strong>Votre note</strong>
                <p>Le score est attribué sur une échelle de 0 à 5. Il reflète votre performance sur la période.</p>
            </div>
        </div>
        <div class="guide-item">
            ...
            <div class="guide-text">
                ...
                <p>L'évaluation a été réalisée par votre manager ou l'administrateur de l'entreprise.</p>
            </div>
        </div>
        <div class="guide-item">
            ...
            <div class="guide-text">
                ...
                <p>Lisez attentivement les remarques pour identifier vos points forts et vos axes de progression.</p>
            </div>
        </div>
    </div>
</div>
