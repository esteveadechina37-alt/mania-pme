...
<div class="page-header animate-in">
    <div>
        <h1 class="page-title">
            <i class="fas fa-star" style="color:var(--primary);"></i> Mes évaluations
        </h1>
...
<div class="content-grid">
    <div class="table-card animate-in delay-1">
        <div class="table-header">
            <h3><i class="fas fa-list"></i> Liste des évaluations</h3>
            <span class="table-count">{{ $evaluations->total() }} évaluation(s)</span>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <a href="{{ route('employee.evaluations.show', $eval) }}" class="btn-view">
    ...
    <div class="guide-card animate-in delay-2">
        ...
        <div class="guide-item">
            ...
            <div class="guide-text">
                ...
                <p>Note de 0 à 5. Couleur selon performance.</p>
            </div>
        </div>
        <div class="guide-item">
            ...
            <div class="guide-text">
                ...
                <p>Réalisées par votre manager ou admin.</p>
            </div>
        </div>
        <div class="guide-item">
            ...
            <div class="guide-text">
                ...
                <p>Cliquez sur "Voir" pour lire les remarques.</p>
            </div>
        </div>
    </div>
</div>
